...
export default abstract class ExtContext implements MscxModuleContextFuncs {
  constructor() {}

  private fwReady = false
  private blockCmds?: [string, any[]][]
  private linkers?: Record<string, MscxLinkFn[]>
  ...
  private listeners?: Record<string, MscxEventListener[]>
  ...
  disconnectSignal(clazz: string, signal: string, slot: MscxSlotFn) {
    const ss: [string, string, MscxSlotFn[]][] = []
